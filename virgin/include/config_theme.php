...
function virgin_maintenance() {
  wp_die('<h1>Site en maintenance temporaire</h1>
         <p>Nous sommes en maintenance pour une bonne partie de la journée, veuillez revenir plus tard </p>');
}
//add_action('get_header', 'virgin_maintenance');
